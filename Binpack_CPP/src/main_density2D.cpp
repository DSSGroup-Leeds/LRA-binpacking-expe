                             ...
                             const vector<string> & list_spread)
{
    ...
    return std::to_string(LB) + "\t" + std::to_string(best_sol) + row + row_time;
}
                   ...
                   int bin_cpu_capacity, int bin_mem_capacity)
{
    ...
    // Header line
    string header("instance_name\tLB\tbest_sol");
    string time_header;
...
int main(int argc, char** argv)
{
    ...
    string outfile("test_" + to_string(bin_cpu_capacity) + "_" + to_string(bin_mem_capacity) + ".csv");
    ...
    run_list_algos(input_path, outfile, list_algos, list_spread, bin_cpu_capacity, bin_mem_capacity);
